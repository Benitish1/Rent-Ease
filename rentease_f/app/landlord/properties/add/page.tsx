            ...
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={handleCheckboxChange("amenities", "heating")}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={handleCheckboxChange("amenities", "kitchen")}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={handleCheckboxChange("amenities", "washer")}
                />
