  ...
  const fetchChats = async () => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8082/api/chats/tenant/${user.id}`,
        {
          method: "GET",
          headers: {
    ...
    <div className="container py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Chat with landlords about properties and bookings
        </p>
      </div>
      ...
      <div className="grid h-[600px] gap-6 md:grid-cols-2">
                  ...
                  {chats.map((chat) => (
                    ...
                    >
                      ...
                      <div className="flex-1 overflow-hidden">
                        <p className="font-medium">{chat.propertyTitle}</p>
                        <p className="text-sm text-muted-foreground">
        ...
        <Card className="flex flex-col">
          <CardHeader>
            <CardTitle>
              {selectedChat ? selectedChat.propertyTitle : "Select a chat"}
            </CardTitle>
          </CardHeader>
          <CardContent className="flex-1 overflow-hidden">
            {selectedChat ? (
                ...
                <ScrollArea className="h-[400px]">
                  <div className="space-y-4 p-4">
                    {messages.map((message) => {
                      const isOwnMessage =
                        message.senderId === selectedChat.landlordId;
                      return (
                        <div
                          key={message.id}
                          className={`flex ${
