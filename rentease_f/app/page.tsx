    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="relative h-[1000px]">
          ...
          <div className="container relative z-10 py-48 md:py-56 lg:py-64">
            <div className="max-w-4xl space-y-6 text-white">
              <h1 className="text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl">
                Find Your Perfect Home with RentEase
              </h1>
              <p className="text-xl md:text-2xl text-white/90">
                Browse thousands of properties, book viewings, and secure your
                next home - all in one place.
              </p>
            </div>
        ...
        <section className="container py-16 md:py-24">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-muted-foreground">
              Hear from tenants and landlords who have experienced the RentEase
              difference
            </p>
          </div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-primary-foreground/90 text-lg">
                  Join thousands of happy tenants and landlords on RentEase
                  today. Start browsing properties or list your own in minutes.
                </p>
              </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Making property rental simple, secure, and stress-free for
                everyone.
              </p>
